...
<div class="container">
    ...
    ?>
    <form class="form-horizontal" method="POST" action="update.pf.php">
        <fieldset>
        ...
        // continuação do conteúdo do form
                echo '
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input id="cpf" name="cpf" disabled placeholder="Apenas números" onchange="desabilitaEdit()" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" value="'.$dados["cpf"].'" class="form-control input-md" required type="text" maxlength="14">
                        </div>
                        <label class="col-md-1 control-label" for="dtnasc">Nascimento</label>
                        <div class="col-md-2">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                <input id="dtnasc" name="dtnasc" disabled value="'.$dt.'" onchange="desabilitaEdit()" pattern="\d{1,2}/\d{1,2}/\d{4}" placeholder="DD/MM/AAAA" class="form-control input-md" required type="text" maxlength="10">
                            </div>
                        </div>';
                        $check_f = '';
                        $check_m = '';
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                ...
                                <input id="tel" name="tel" value="'.$dados["telefone"].'" onchange="desabilitaEdit()" pattern="\d{4}-\d{4}" class="form-control" disabled placeholder="XXXX-XXXX" type="tel" maxlength="9">
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                            <button type="button" id="pesquisar" class="btn btn-primary" disabled onclick="getEndereco()">Pesquisar</button>
                    </div>
                </div>
                <div class="form-group">
